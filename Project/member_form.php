            ...
            <div id="join_box">
                <form name="member_form" method="post" action="member_insert.php">
                    ...
                    <div class="form id">
                        ...
                        <div class="col2">
                            <input type="text" name="id" id="id_text">
                        </div>
                        <div class="col3">
                            <a href="#"><img src="./img/id_check.png" onclick="check_id()"></a>
                        </div>
                    </div>
                    <div class="clear"></div>
                    ...
                    <div class="form">
                        ...
                        <div class="col2"><input type="number" name="birth" placeholder="예)19970923"></div>
                    </div>
                    <div class="clear"></div>
