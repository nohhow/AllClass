            ...
            echo '<div class="col-xl-3 col-md-6">
                <div class="card bg-warning text-white mb-4">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="class_detail.php?class_name='.$class_list['class_name'].'&class_info='.$class_list['class_info'].'&class_code='.$class_list['class_code'].'">View details</a>
